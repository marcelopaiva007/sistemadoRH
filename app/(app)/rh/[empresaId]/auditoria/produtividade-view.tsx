        ...
        <div className="grid gap-3 sm:grid-cols-3">
          {top3[0] && (
            <Indicador
              ...
              icone={<Trophy className="size-4 text-muted-foreground" />}
          ...
          {top3[1] && (
            <Indicador
              ...
              icone={<Medal className="size-4 text-muted-foreground" />}
          ...
          {top3[2] && (
            <Indicador
              ...
              icone={<Award className="size-4 text-muted-foreground" />}
